...
class Person : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person) */ {
 public:
  ...
  bool has_tmp() const;
  void clear_tmp();
  static const int kTmpFieldNumber = 5;
  const ::infopack::info& tmp() const;
  ::infopack::info* mutable_tmp();
  ::infopack::info* release_tmp();
  void set_allocated_tmp(::infopack::info* tmp);
...
inline ::infopack::info* Person::release_tmp() {
...
inline void Person::set_allocated_tmp(::infopack::info* tmp) {
  delete tmp_;
  tmp_ = tmp;
  if (tmp) {
