...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person, tmp_),
  ~0u,  // no _has_bits_
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::infopack::protobuf_info_2eproto::InitDefaults();
  ...
  _Person_default_instance_.get_mutable()->tmp_ = const_cast< ::infopack::info*>(
      ::infopack::info::internal_default_instance());
}
...
const int Person::kTmpFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
Person::Person(const Person& from)
  ...
  if (from.has_tmp()) {
    tmp_ = new ::infopack::info(*from.tmp_);
  } else {
    tmp_ = NULL;
  }
  id_ = from.id_;
...
void Person::SharedCtor() {
  name_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  email_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&tmp_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&id_) -
      reinterpret_cast<char*>(&tmp_)) + sizeof(id_));
  _cached_size_ = 0;
}
...
// @@protoc_insertion_point(message_clear_start:tutorial.Person)
  ...
  if (GetArenaNoVirtual() == NULL && tmp_ != NULL) {
    delete tmp_;
  }
  tmp_ = NULL;
  id_ = 0;
...
::google::protobuf::uint8* Person::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_tmp()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, *this->tmp_, deterministic, target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.Person)
  ...
  if (from.has_tmp()) {
    mutable_tmp()->::infopack::info::MergeFrom(from.tmp());
  }
  if (from.id() != 0) {
    set_id(from.id());
  }
...
// .infopack.info tmp = 5;
bool Person::has_tmp() const {
  return this != internal_default_instance() && tmp_ != NULL;
}
void Person::clear_tmp() {
  if (GetArenaNoVirtual() == NULL && tmp_ != NULL) delete tmp_;
  tmp_ = NULL;
}
const ::infopack::info& Person::tmp() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.tmp)
  return tmp_ != NULL ? *tmp_
                         : *::infopack::info::internal_default_instance();
}
::infopack::info* Person::mutable_tmp() {
  
  if (tmp_ == NULL) {
    tmp_ = new ::infopack::info;
  }
  // @@protoc_insertion_point(field_mutable:tutorial.Person.tmp)
  return tmp_;
}
::infopack::info* Person::release_tmp() {
  // @@protoc_insertion_point(field_release:tutorial.Person.tmp)
  
  ::infopack::info* temp = tmp_;
  tmp_ = NULL;
  return temp;
}
void Person::set_allocated_tmp(::infopack::info* tmp) {
  delete tmp_;
  tmp_ = tmp;
  if (tmp) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tutorial.Person.tmp)
}
